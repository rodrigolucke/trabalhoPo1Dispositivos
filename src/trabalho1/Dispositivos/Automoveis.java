 ...
 * @author home
 */
public class Automoveis extends UnidadesTransporte {
    
    public Automoveis(int automatico, Regiao r) {
        super(automatico, r);
    }
    ...
    public String toString() {
        return "Automóvel "+super.toString(); //To change body of generated methods, choose Tools | Templates.
    }
